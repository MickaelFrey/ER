...
/*
 * Play little game with L and R button. The purpose is to align three
 * graphics background that turn with L and R keys.
 */
void play_hotpot();
...
/*
 * Display picture that help to understand the morse code
 */
void play_card();

/*
 * Display the locker; enter a five digit code to unlock it
 */
